...
$DomainNetbiosName = Read-Host "Enter the NetBIOS name of the Active Directory domain"
$SafeModeAdministratorPassword = Read-Host "Enter the password for the Safe Mode Administrator account" -AsSecureString
